...
public class Ejercicio03 {
	...
	/*
	 * Realizar un programa en java que permita leer n precios de productos al final
	 * mostrar un arreglo resultante en donde se le calcule el 10% de descuento a
	 * aquellos precios de productos superirores a 55.000 mil pesos y los demas
	 * casos aplicar el 5% de descuento
	 * 
	 */
